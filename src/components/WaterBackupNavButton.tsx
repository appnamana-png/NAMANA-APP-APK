...
export const WaterBackupNavButton: React.FC<WaterBackupNavButtonProps> = ({
  ...
  return (
    <button
      ...
      className={`relative flex items-center justify-center text-center gap-1 md:gap-1.5 px-2 md:px-2.5 lg:px-3 py-1 lg:py-1.5 rounded-xl text-[11px] lg:text-xs font-bold transition-all cursor-pointer overflow-hidden border whitespace-nowrap ${
        isJustBackedUp
